...
public class ControlExecutor {
    ...
    public double execute(String commandName, List<Object> arguments, TurtleHistory turtleHistory, Map<String, Double> variables) throws ClassNotFoundException {
        try {
            ...
            return ((ControlInterface) classConstructor.newInstance()).execute(turtleHistory, arguments, variables);
